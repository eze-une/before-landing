...
function TeamImage({image,link,name,position,id,show,onShow}) {
  ...
  return (
    <m.div
      ...
      transition={spring}
      onClick={handleShow}
      className={show ? "item-click relative" : "item relative"}
    >
      ...
      >
        ...
        <div className={show ? "text-2xl text-[#57BE94]" : "hidden"}>
