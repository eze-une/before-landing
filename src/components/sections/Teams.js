...
export default function Teams() {
  return (
    <>
      <div
        className="flex flex-col w-full py-10 snapped bg-[#F6F9FF]"
        id="teams"
      >
        ...
        <div className="w-full h-full flex flex-col md:flex-row justify-start items-center snap start">
          <div className=" h-full w-full mt-10 md:mt-0  md:w-[40%] flex flex-row items-center justify-center pr-10">
            <div className="h-[300px] w-10 md:w-10  bg-[#57BE94] ml-[1rem]  mr-[2rem]"></div>
